...
export class AddRecursoComponent implements OnInit {
  ...
  constructor(private categoriaService: CategoriasService, private tipoService: TiposService, private recursoService: RecursosService, public dialogRef: MatDialogRef<AddRecursoComponent>) { }
  ...
  addRecurso(){
    const addRecursoDto = new AddRecursoDto(this.title, this.autor, this.anyo, this.content, this.tipoSeleccionado, this.categoriaSeleccionada);
